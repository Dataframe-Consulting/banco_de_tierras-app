...
import { IPropiedad } from "@/app/shared/interfaces";
...
const columns = [
  ...
  {
    name: "Adeudo Predial",
    selector: (row: { adeudo_predial?: number }) => row.adeudo_predial ?? "N/A",
    sortable: true,
...
const PropiedadesDataTable = ({ propiedades }: IPropiedadesDataTable) => {
